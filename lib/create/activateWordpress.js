...
var description = exports.description = 'activate WordPress theme and plugins';
...
function run(answers) {
  var cmds = ['wp option set blog_public 0', 'wp theme activate ' + answers.themeName, 'echo "apache_modules:\n  - mod_rewrite\n" >> wp-cli.yml', 'wp rewrite structure /%postname%/ --hard', 'wp plugin activate --all'];
