...
function run(answers) {
  ...
  composerJson.repositories.push(repos.flyntCore, repos.acfFieldGroupComposer);
  ...
  if (answers.composerRepos) {
    ...
    composerJson.repositories.push.apply(composerJson.repositories, composerRepos);
  }
