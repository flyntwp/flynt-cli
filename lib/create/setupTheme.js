...
var description = exports.description = 'setup new theme from flynt-theme repo';
...
function run(answers) {
  ...
  var cmds = ['git clone --depth=1 "git@github.com:bleech/wp-starter-theme.git" ' + themePath, 'cd ' + themePath, 'rm -rf .git'];
