...
const description = exports.description = 'create the database with root user for specified user';

const runMessage = exports.runMessage = 'Creating database...';

const requirements = exports.requirements = [allRequirements.mysql];

const prompts = exports.prompts = [allPrompts.dbHost, allPrompts.dbRootUser, allPrompts.dbRootPassword, allPrompts.dbName, allPrompts.dbUser, allPrompts.dbPassword];

function run(answers) {
  let cmds = [`mysql --host=${answers.dbHost} --user=${answers.dbRootUser} --password=${answers.dbRootPassword} -e \
