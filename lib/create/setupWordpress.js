...
var description = exports.description = 'set dotenv values and isntall WordPress db';

var requirements = exports.requirements = [allRequirements.wpCli, allRequirements.wpCliDotenv];

var prompts = exports.prompts = [allPrompts.dbName, allPrompts.dbUser, allPrompts.dbPassword, allPrompts.dbHost, allPrompts.wpEnv, allPrompts.wpHome, allPrompts.wpSiteurl, allPrompts.wpTitle, allPrompts.wpAdminName, allPrompts.wpAdminEmail, allPrompts.acfProKey];
