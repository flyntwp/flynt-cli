...
const description = exports.description = 'set dotenv values and install WordPress db';

const runMessage = exports.runMessage = 'Installing WordPress...';
...
function notify(stdout, stderr) {
  const stdoutCallback = function stdoutCallback(data) {
    const line = data.toString();
    if (_lodash2.default.includes(line, 'Admin password:')) {
