...
const description = exports.description = 'run yarn build for flynt theme';

const runMessage = exports.runMessage = 'Building theme...';
...
function run(answers) {
  ...
  let cmds = [`cd ${themePath}`, 'yarn build'];
