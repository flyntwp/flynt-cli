...
const description = exports.description = 'upgrade theme dependencies with yarn';

const runMessage = exports.runMessage = 'Upgrading node dependencies...';
...
function run(answers) {
  ...
  let cmds = [`cd ${themePath}`, 'yarn upgrade'];
