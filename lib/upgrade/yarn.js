...
var description = exports.description = 'upgrade theme dependencies with yarn';

var requirements = exports.requirements = [allRequirements.yarn];

var prompts = exports.prompts = [allPrompts.themeName];

function run(answers) {
  var themePath = 'web/app/themes/' + answers.themeName;
  var cmds = ['cd ' + themePath, 'yarn upgrade'];
