...
var prompts = exports.prompts = [allPrompts.basePath, allPrompts.wpHome, allPrompts.dbHost, allPrompts.dbUser, allPrompts.dbName, allPrompts.dbPassword, allPrompts.sshHost, allPrompts.sshUser, allPrompts.sshPort, allPrompts.basePathRemote, allPrompts.wpHomeRemote, allPrompts.dbHostRemote, allPrompts.dbUserRemote, allPrompts.dbNameRemote, allPrompts.dbPasswordRemote, allPrompts.sshHostRemote, allPrompts.sshUserRemote, allPrompts.sshPortRemote];
...
function run(answers) {
  ...
  var searchStrings = [answers.wpHome, _path2.default.resolve(answers.basePath)];
  var replaceStrings = [answers.wpHomeRemote, _path2.default.resolve(answers.basePathRemote)];
