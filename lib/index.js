...
_yargs2.default.command('create', 'Create a new flynt project', (0, _buildArguments2.default)(createCmd, 'argv.env'), (0, _handleCommand2.default)(createCmd, 'argv.env')).command('clone', 'Clone database and medie files between environments', function (yargs) {
