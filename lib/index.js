...
var _requireComposerPackages = require('./setup/requireComposerPackages');
...
var requirements = [installBedrock, requireComposerPackages].map(function (task) {
  return task.requirements;
});

var prompts = [installBedrock, requireComposerPackages].map(function (task) {
  return task.prompts;
});

var runs = [installBedrock, requireComposerPackages].map(function (task) {
  return task.run;
});
