...
var _setupTheme = require('./setup/setupTheme');

var setupTheme = _interopRequireWildcard(_setupTheme);

var _createDb = require('./setup/createDb');
...
var _activateWordpress = require('./setup/activateWordpress');
...
// createDb,
// setupWordpress,
activateWordpress].map(function (task) {
