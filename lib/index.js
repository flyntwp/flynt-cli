...
var commands = ['create', 'setup', 'install', 'upgrade', 'start', 'build', 'clone', 'deploy'];

var cli = _yargs2.default.usage('Usage: $0 <command> [<subcommand>] [options]');

commands.forEach(function (command) {
  var cmdObject = require('./' + command);
