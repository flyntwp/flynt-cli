...
_yargs2.default.command('setup', 'Setup a new flynt project', function (yargs) {
  setupCmd.cmds.forEach(function (cmd) {
    yargs = yargs.command(cmd, '', {}, (0, _handleCommand2.default)(setupCmd, 'argv.env', null, cmd));
  });
  return yargs;
}, (0, _handleCommand2.default)(setupCmd, 'argv.env')).command('clone', 'Clone database and medie files between environments', function (yargs) {
  cloneCmd.cmds.forEach(function (cmd) {
    yargs = yargs.command(cmd, '', {}, (0, _handleCommand2.default)(cloneCmd, 'argv.from', 'argv.to', cmd));
  });
  ...
  cloneCmd.cmds.forEach(function (cmd) {
    yargs = yargs.command(cmd, '', {}, (0, _handleCommand2.default)(deployCmd, 'local', 'argv.to', cmd));
  });
