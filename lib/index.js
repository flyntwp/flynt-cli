...
}, (0, _handleCommand2.default)(cloneCmd, 'argv.from', 'argv.to')).command('deploy', deployCmd.description, function (yargs) {
  (0, _buildArguments2.default)(deployCmd, 'local', 'argv.to', {
    to: {
      describe: 'Environment to clone to',
      type: 'string',
      default: 'development'
