...
_yargs2.default.command('create', 'Create a new flynt project', (0, _buildArguments2.default)(createCmd, 'argv.env'), (0, _handleCommand2.default)(createCmd, 'argv.env')).command('install', 'Install flynt dependencies (yarn, composer)', (0, _buildArguments2.default)(installCmd, 'argv.env'), (0, _handleCommand2.default)(installCmd, 'argv.env')).command('upgrade', 'Upgrade flynt dependencies (yarn, composer)', (0, _buildArguments2.default)(upgradeCmd, 'argv.env'), (0, _handleCommand2.default)(upgradeCmd, 'argv.env')).command('watch', 'Run yarn watch for flynt theme', (0, _buildArguments2.default)(watchCmd, 'argv.env'), (0, _handleCommand2.default)(watchCmd, 'argv.env')).command('clone', 'Clone database and medie files between environments', function (yargs) {
